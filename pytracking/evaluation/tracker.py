...
from pytracking.pytracking.utils.plotting import draw_figure, overlay_mask
from pytracking.pytracking.utils.convert_vot_anno_to_rect import convert_vot_anno_to_rect
