...
def run_tracker_on_tensor(
    tracker_name, tracker_param, run_id=None, sequence=None, debug=0, threads=0, visdom_info=None
):
    ...
    run_tensor_dataset(dataset, trackers, debug, threads, visdom_info=visdom_info)
